...
// */
//
//public class MongoCom {//extends AsyncTask<Object, Void, Boolean> {
//
...
////
////        try {
////            URL url = new URL("https://api.mlab.com/api/1/databases/holotours/collections/" + obj.returnObjType() + "?apiKey=ZAEcZeOleMn2BNRDBkDsCJ8VkoohKQlx");
////
...
////
////            osw.write(obj.returnWriteString());
////            osw.flush();
////            osw.close();
////

...
public class ResourceLink {
    ...
    public final static String soundNames[] = {
            "1. MoA and CSA Description and Mission",
            "2. Basic Info About Lotte Jacobi",
            "3. Introduce Photographs - Top Row",
            "4. Introduce Photographs - Bottom Row",
            "5. Explanation of Connection Between Photogenics and Dancers",
            "6. Connection to Library Exhibition"
    };

    public final static Integer soundID[] = {
        R.raw.moa_and_csa_description_and_mission,
            R.raw.basic_info_about_lotte_jacobi,
            R.raw.introduce_photographs_top_row,
            R.raw.introduce_photographs_bottom_row,
